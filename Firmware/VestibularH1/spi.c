...
{
	/* Initialize SPI with 2MHz */
	SPID_CTRL = SPI_MASTER_bm | SPI_ENABLE_bm | SPI_MODE_0_gc /*| SPI_CLK2X_bm*/ | SPI_PRESCALER_DIV128_gc;
}

void spi_mode3_initialize_flow1(void)
{
	/* Initialize SPI with 2MHz */
	SPID_CTRL = SPI_MASTER_bm | SPI_ENABLE_bm | SPI_MODE_3_gc /*| SPI_CLK2X_bm*/ | SPI_PRESCALER_DIV128_gc;
}
